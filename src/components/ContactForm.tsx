  ...
  if (status === "sent") {
    return (
      <div className="rounded-2xl border border-accent-green/20 bg-accent-green/5 p-8 text-center">
        ...
        <button onClick={() => setStatus("idle")} className="mt-4 text-sm text-accent-orange hover:underline">
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          name="name"
          required
          className="w-full rounded-xl border border-white/10 bg-card px-4 py-3 text-white placeholder-text-secondary focus:border-accent-orange/50 focus:outline-none"
      ...
      <div>
        ...
        <select
          ...
          name="subject"
          required
          className="w-full rounded-xl border border-white/10 bg-card px-4 py-3 text-white focus:border-accent-orange/50 focus:outline-none"
        >
      ...
      <button
        ...
        className="w-full rounded-2xl bg-gradient-to-b from-[#ffb347] via-accent-orange to-[#e8890a] py-4 font-game text-lg text-bg shadow-[0_4px_0_#c77008] transition-transform hover:-translate-y-0.5 disabled:opacity-50"
      >
